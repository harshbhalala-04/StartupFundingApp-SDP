...
import 'package:startupfunding/controllers/startup_controllers/view_funding_controller.dart';

class ViewFundingScreen extends StatefulWidget {
  final String workStreamId;
  ViewFundingScreen({required this.workStreamId});
  @override
  State<ViewFundingScreen> createState() => _ViewFundingScreenState();
}

class _ViewFundingScreenState extends State<ViewFundingScreen> {
