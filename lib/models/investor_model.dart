...
class InvestorModel {
    ...
    factory InvestorModel.fromJson(Map<String, dynamic> json) => InvestorModel(
        ...
        experience: json["experience"] == null ? null : List<String>.from(json["experience"].map((x) => x)),
        expertise: json["expertise"] == null ? null : List<String>.from(json["expertise"].map((x) => x)),
        firstName: json["firstName"] == null ? null : json["firstName"],
        investedBefore: json["investedBefore"] == null ? null : json["investedBefore"],
        investorImg: json["investorImg"] == null ? null : json["investorImg"],
        lastName: json["lastName"] == null ? null : json["lastName"],
        linkedinUrl: json["linkedinUrl"] == null ? null : json["linkedinUrl"],
        mentorStartup: json["mentorStartup"] == null ? null : json["mentorStartup"],
        phoneNo: json["phoneNo"] == null ? null : json["phoneNo"],
        preferInvestment: json["preferInvestment"] == null ? null : json["preferInvestment"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "experience": experience == null ? null : List<dynamic>.from(experience!.map((x) => x)),
        "expertise": expertise == null ? null : List<dynamic>.from(expertise!.map((x) => x)),
